...
export const BILDUNGSSTUFEN = Object.keys(BILDUNGSSTUFE_MAPPING) as (keyof typeof BILDUNGSSTUFE_MAPPING)[];
export const FAECHER = Object.keys(FACH_MAPPING) as (keyof typeof FACH_MAPPING)[];
export const INHALTSTYPEN = Object.keys(INHALTSTYP_MAPPING) as (keyof typeof INHALTSTYP_MAPPING)[];